...
- `skills/SKILL.md` mirrors `/app/L0/_all/mod/_core/skillset/AGENTS.md`, `/app/L0/_all/mod/_core/onscreen_agent/AGENTS.md`, the shared skill-runtime helper, and the onscreen skill runtime contract
